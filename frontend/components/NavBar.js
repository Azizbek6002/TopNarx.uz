  ...
  return (
    <>
      <style>{`
        ...
        .tnav-drawer-link svg { opacity: 0.5; transition: opacity 0.2s; width: 18px; height: 18px; }
        ...
        @media (max-width: 720px) {
          ...
          .tnav-cta-desktop { display: none !important; }
          .tnav-icons { display: none !important; }
          .tnav-sep { display: none !important; }
      ...
      <div className={`tnav-drawer${menuOpen ? " open" : ""}`}>
        ...
        {!isLoadingUser && (
          user ? (
            <div className="tnav-drawer-user-section">
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                <div style={{
                  width: "44px", height: "44px", borderRadius: "50%",
                  background: "linear-gradient(135deg, #2d6a4f 0%, #1b4332 100%)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "18px", fontWeight: "500", border: "1px solid rgba(82,183,136,0.3)"
                }}>
                  {getUserInitial()}
                </div>
                <div style={{ textAlign: "left" }}>
                  <div style={{ fontWeight: "500", fontSize: "15px", color: "#f5f0e8" }}>{getUserDisplayName()}</div>
                  <div style={{ fontSize: "11px", color: "#7a7168" }}>{user.email}</div>
                  <div style={{
              ...
              <Link href={user.role === 'owner' ? "/owner/dashboard" : "/profile"}
                    className="tnav-drawer-link" style={{ justifyContent: "center", background: "rgba(82,183,136,0.1)", marginBottom: "4px" }}>
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              ...
              <Link href="/favorites" className="tnav-drawer-link" style={{ justifyContent: "center", marginBottom: "4px" }}>
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              ...
              <div className="tnav-drawer-link" onClick={handleLogout} style={{ cursor: "pointer", justifyContent: "center" }}>
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
